	...
	<div class="addEdit-block" :style='{"padding":"85px 30px 30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="退房申请" prop="tuifangshenqing">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.tuifangshenqing" 
						type="datetime"
						:readonly="ro.tuifangshenqing"
						placeholder="退房申请"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.tuifangshenqing" label="退房申请" prop="tuifangshenqing">
					<el-input v-model="ruleForm.tuifangshenqing" placeholder="退房申请" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="退房备注" prop="tuifangbeizhu">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="退房备注"
					  v-model="ruleForm.tuifangbeizhu" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.tuifangbeizhu" label="退房备注" prop="tuifangbeizhu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"400px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.tuifangbeizhu}}</span>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.tuifangshenqing = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tuifangshenqing'){
							this.ruleForm.tuifangshenqing = obj[o];
							this.ro.tuifangshenqing = true;
							continue;
						}
						if(o=='tuifangbeizhu'){
