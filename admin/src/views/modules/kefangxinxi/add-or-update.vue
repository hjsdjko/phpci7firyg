	...
	<div class="addEdit-block" :style='{"padding":"85px 30px 30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="客房类型" prop="kefangleixing">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="客房设施" prop="kefangsheshi">
					<el-input
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.kefangsheshi" label="客房设施" prop="kefangsheshi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"400px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.kefangsheshi}}</span>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-if="type!='info'"  label="酒店详情" prop="jiudianxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jiudianxiangqing" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.jiudianxiangqing" label="酒店详情" prop="jiudianxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"400px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiudianxiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiudianxiangqing'){
							this.ruleForm.jiudianxiangqing = obj[o];
							this.ro.jiudianxiangqing = true;
							continue;
						}
						if(o=='thumbsupnum'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiudianxiangqing = this.ruleForm.jiudianxiangqing.replace(reg,'../../../phpci7firyg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
